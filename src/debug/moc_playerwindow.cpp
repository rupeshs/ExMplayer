...
**
** Created: Mon Apr 1 19:08:57 2013
...
static const char qt_meta_stringdata_PlayerWindow[] = {
    ...
    "on_actionDefault_zoom_triggered()\0"
    "on_actionChange_framerate_triggered()\0"
    "on_actionDefault_triggered()\0"
    "on_actionIncrease_Video_quality_triggered()\0"
    "on_actionMove_Down_triggered()\0"
    "on_actionMove_Up_triggered()\0"
    "on_actionMove_Right_triggered()\0"
    "on_actionMove_Left_triggered()\0"
    "on_actionDecrease_Zoom_triggered()\0"
    "on_actionIncrease_Zoom_triggered()\0"
    "on_toolButtonSpeed_clicked()\0"
    "on_actionAudio_extrctor_triggered()\0"
    "on_actionSide_view_triggered()\0"
    "on_actionTwins_triggered()\0"
    "on_actionAdd_Folder_to_pl_triggered()\0"
    "on_actionAdd_File_to_pl_triggered()\0"
    "on_actionEdit_Playlist_triggered()\0"
    "on_actionSave_cover_art_triggered()\0"
    "on_actionFolder_triggered()\0"
    "on_toolButton_playnext_clicked()\0"
    "on_toolButton_playpre_clicked()\0checked\0"
    "on_toolButton_shuffle_toggled(bool)\0"
    "on_toolButton_loop_toggled(bool)\0"
    "on_toolButtonfs_clicked()\0"
    "on_actionMix_and_save_triggered()\0"
    "on_actionAbout_Qt_triggered()\0"
    "on_action_Help_triggered()\0"
    "on_cbEnableAEq_clicked()\0"
    "on_actionShowpl_triggered()\0"
    "on_actionMedia_cutter_triggered()\0"
    "on_actionEnable_Closed_Captions_triggered()\0"
    "on_action_About_triggered()\0"
    "on_actionOpen_containing_folder_triggered()\0"
    "on_action_Load_pl_triggered()\0action\0"
    "on_eq0_actionTriggered(int)\0"
    "on_actionPlay_Previous_File_triggered()\0"
    "on_actionPlay_Next_File_triggered()\0"
    "on_action_Save_as_playlist_triggered()\0"
    "on_actionURL_triggered()\0value\0"
    "on_eq3_valueChanged(int)\0"
    "on_cbEnableAEq_stateChanged(int)\0"
    "on_actionWinamp_Dsp_triggered()\0"
    "on_actionNegative_triggered()\0"
    "on_actionVolume_Normalization_triggered()\0"
    "on_action_Options_triggered()\0"
    "on_sliderSeek_valueChanged(int)\0"
    "on_action_Media_Info_triggered()\0"
    "on_sliderVolume_actionTriggered(int)\0"
    "on_actionSelected_item_s_triggered()\0"
    ...
    "on_action_AV_Set_Delay_triggered()\0"
    "on_action_st_Set_Delay_triggered()\0"
    "on_actionDelay_Decrease_triggered()\0"
    "on_actionDelay_Increaser_triggered()\0"
    "on_action_st_Move_Down_triggered()\0"
    "on_action_st_Move_Up_triggered()\0"
    "on_actionStUnload_triggered()\0"
    "on_actionSize_Decrease_triggered()\0"
    "on_actionSize_Increase_triggered()\0"
    "on_action_Load_st_triggered()\0"
    "on_action_Equalizer_triggered()\0"
    "toggle_bottomdock_visibility()\0"
    "on_actionVideoEqualizer_triggered()\0"
    "index\0on_comboBox_currentIndexChanged(int)\0"
    "on_btnAEReset_clicked()\0bandval\0"
    "setequlizerbandvalue(int)\0"
    "on_gamma_valueChanged(int)\0"
    "on_Saturation_valueChanged(int)\0"
    "on_Hue_valueChanged(int)\0"
    "on_brightness_valueChanged(int)\0"
    "on_contrast_valueChanged(int)\0values\0"
    "animate_ae_slider(QStringList)\0event\0"
    "contextMenuEvent(QContextMenuEvent*)\0"
    "on_btnVEReset_clicked()\0"
    "on_actionToggle_subtitle_visibility_triggered()\0"
    "on_action_Open_Screenshot_folder_triggered()\0"
    "on_actionStart_stop_Screenshot_triggered()\0"
    "on_actionScreen_shot_triggered()\0"
    "on_actionToggle_Frame_drop_triggered()\0"
    "on_actionToggle_OSD_triggered()\0"
    "on_actionFrame_step_triggered()\0"
    "on_actionStay_on_top_triggered()\0"
    "on_action_Crop_triggered()\0"
    "on_actionStep2_fm_triggered()\0"
    "on_actionStep1_fm_triggered()\0"
    "on_action_Palette_triggered()\0"
    "on_actionVisualize_motion_vectors_triggered()\0"
    "on_actionMatrixview_triggered()\0"
    "on_action_Blur_triggered()\0"
    "on_actionAdd_noise_triggered()\0"
    "on_actionPainting_triggered()\0"
    "on_actionOld_Black_and_white_triggered()\0"
    "on_actionSwap_U_and_V_triggered()\0"
    "on_action50_50_triggered()\0"
    "on_action_Mirror_triggered()\0"
    "on_action_flip_triggered()\0"
    "on_action_Tile_triggered()\0"
    "on_action_Remove_logo_triggered()\0"
    "on_action_Delay_triggered()\0"
    "on_actionScale_Tempo_triggered()\0"
    "on_action_ExtraStereo_triggered()\0"
    "on_actionSurroundAf_triggered()\0"
    "on_action_Karaoke_triggered()\0"
    "on_actionLoad_external_file_triggered()\0"
    "on_action_Decrease_volume_triggered()\0"
    "on_action_Increase_volume_triggered()\0"
    "on_actionDecrease_Delay_triggered()\0"
    "on_actionIncrease_Delay_triggered()\0"
    "on_actionDecrease_10_triggered()\0"
    "on_actionIncrease_10_triggered()\0"
    "on_actionHalve_speed_triggered()\0"
    "on_actionDouble_speed_triggered()\0"
    "on_actionNormal_Speed_triggered()\0"
    "on_actionRewind_10_minutes_triggered()\0"
    "on_actionForward_10_minutes_triggered()\0"
    "on_actionRewind_1_minute_triggered()\0"
    "on_actionForward_1_minute_triggered()\0"
    "on_actionRewind_10_seconds_triggered()\0"
    "on_actionForward_10_seconds_triggered()\0"
    "on_action_File_triggered()\0"
    "on_action_Stop_triggered()\0"
    "on_action_Exit_triggered()\0"
    "on_actionMute_triggered()\0"
    "on_action_Play_Pause_triggered()\0"
    "on_toolButtonVolume_clicked()\0"
    "on_sliderVolume_valueChanged(int)\0"
    "on_toolButtonRewind_clicked()\0"
    "on_toolButtonForward_clicked()\0"
    "on_sliderSeek_actionTriggered(int)\0"
    "on_cmdLine_returnPressed()\0"
    "on_btnSaveLog_clicked()\0setupLogWindow()\0"
    "setupPlaylistWindow()\0setupMyUi()\0"
    "resetUi()\0file,type\0initMPlayer(QString,int)\0"
    "startingPlayback()\0updateSeekbar()\0"
    "updateFrameDisplay()\0setMutebtnIcon(int)\0"
    "togglePause()\0toggleMute()\0"
    "changesubAlignment(QAction*)\0"
    "change_framedrop(QAction*)\0"
    "change_osd(QAction*)\0changeSubTitles(QAction*)\0"
    "changeAudioTrack(QAction*)\0"
    "changeVideoTrack(QAction*)\0"
    "changeChannel(QAction*)\0"
    "changeSamplingFrequency(QAction*)\0"
    "changeStereoMode(QAction*)\0"
    "changeRotation(QAction*)\0group,key,value\0"
    "settingChanged(QString,QString,QString)\0"
    "val\0rubberBandval(QRect*)\0"
    "changeAspectRatio(QAction*)\0lengthChanged()\0"
    "sl\0foundSubtitletrack(QStringList)\0"
    "updatemetadisp()\0mouseMoveEvent(QMouseEvent*)\0"
    "hidestatus()\0fn\0playThisfile(QString)\0"
    "addfile()\0addFolder()\0"
    "dragEnterEvent(QDragEnterEvent*)\0"
    "dropEvent(QDropEvent*)\0"
    "dragMoveEvent(QDragMoveEvent*)\0cleanMp()\0"
    "paused()\0playing()\0stopping()\0"
    "showCtxmenuPlaylist(QContextMenuEvent*)\0"
    "fp\0addFolderTopl(QString)\0"
    "wheelEvent(QWheelEvent*)\0setEof()\0"
    "pos,pt\0showSeekpos(QString,QPoint*)\0"
    "checkForNextPlayback()\0crossfadePlay()\0"
    "hidebusypg()\0pt\0showtooltip(QPoint*)\0"
    "hideframe()\0loadMPlayerConfig()\0"
    "setcmbIndex()\0file\0addRecentFileAndPlay(QString)\0"
    "url\0playurl(QString)\0createShortcuts()\0"
    "setmousewheelrole()\0toggleFullscreen()\0"
    "ev\0mouseDoubleClickEvent(QMouseEvent*)\0"
    "saveCoverArt()\0removelavf()\0opt,path\0"
    "winExplorer(QString,QString)\0"
    "enableChannels()\0setAqua()\0"
    "disableStylesheet()\0int\0getEh()\0"
    "readCmd()\0connectTosever()\0writeSettings()\0"
    "readSettingsGeo()\0setfbvis(bool)\0"
    "completeRestart()\0msg\0getMessage(QString)\0"
    "clearingList()\0ec,stop\0"
    "playNextAfterFinish(int,bool)\0"
    "showMsgBox(QString)\0QString\0getFilter()\0"
    "path\0showPictureFlow(QString)\0w,hei\0"
    "resizeVideo(int,int)\0useidxnplay()\0"
    "getaudioFilter()\0showctxmenu(QContextMenuEvent*)\0"
    "pfdblClick()\0showpg()\0tex\0showerror(QString)\0"
    "vis\0playlistVisibility(bool)\0"
    "startingPlaybackframe()\0"
    "startProgressiveStreaming()\0wgetDownload()\0"
    "dur\0streamingDuration(float)\0"
    "searchTerm,engine\0searchYT(QString,int)\0"
    "on_actionCopy_Audio_CD_triggered()\0"
    "on_actionInternet_Radio_triggered()\0"
    "url,url2\0playSCUrl(QString,QString)\0"
...
// SIGNAL 0
void PlayerWindow::sgcrossfade()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void PlayerWindow::keyPress(QKeyEvent * _t1)
{
